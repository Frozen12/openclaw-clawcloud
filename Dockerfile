...
# ClawCloud-optimized Dockerfile
# Based on upstream OpenClaw with fixes for ClawCloud deployment
...
LABEL org.opencontainers.image.source="https://github.com/Frozen12/openclaw-clawcloud" \
